...
if [ ! -f .env ]; then
    ...
    env | grep -E '^(APP_|DB_|MYSQL_|REDIS_|QUEUE_|MAIL_|LOG_|PYTHON_|GEMINI_|KIMI_|GLM_|NVIDIA_|MINIMAX_|CLAUDE_|OPENROUTER_|TOKENROUTER_|AI_|FILESYSTEM_|MAX_UPLOAD|ALLOWED_)' > .env 2>/dev/null || true
